...
- To leak the cookies from the admin bot, we can create a JavaScript file named `script.gif.js`. This file will contain the logic to navigate (`location.href`) to our webhook while including the admin bot's cookie.
- By creating multiple comments (redudancy sake) with the title and message set as `<script src="/images/447f81d7-d7a6-4ff4-8619-54fd9ec4aa1cscript.gif.js"></script>`, we can import our malicious script into the page.
